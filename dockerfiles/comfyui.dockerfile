FROM chirvo/uv_pytorch:latest AS base

ARG COMFYUI_RELEASE="v0.3.45" \
...
uv pip install onnx boto3 imageio-ffmpeg setuptools simpleeval insightface
EOF
